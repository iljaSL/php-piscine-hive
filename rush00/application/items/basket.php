<?php
    ...
    echo "<tr><td style='color: rgb(0,199,255); height: 70px; font-weight: bold'>Total: </td><td style='color: #9ACD32; height: 70px;'>$total $</td><td><form method='post'><input style='padding: 10px; margin-top: 10px;' type='submit' name='order' value='Order'></form></td></tr>";
    echo "</table>";
    echo "</div>";
    echo "</div>";
